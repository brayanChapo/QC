...
public class pruebareporte {
	...
	public static void main(String[] args) throws IOException{
			...
			solicitud.put("nombreTarea", "-");
			solicitud.put("tkSolicitud", "-");
			solicitud.put("tkSolicitud", "-");
...
//				for (Map<String, Object> map : listaMapReporte) {
					HSSFRow row = sheet.createRow((short) 1); // crea filan
					row.createCell((short) 0).setCellValue(String.valueOf(solicitud.get("nombreTarea"))); // A2
					row.createCell((short) 1).setCellValue(String.valueOf(solicitud.get("tkSolicitud"))); // B2
					row.createCell((short) 2).setCellValue(String.valueOf(solicitud.get("crqTarea"))); // C2
